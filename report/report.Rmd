...
```{r fig.cap="AWS Subnets", echo=FALSE}
...
```{r fig.cap="EC2 App Servers", echo=FALSE}
...
```{r fig.cap="Security Groups for App Servers", echo=FALSE}
...
```{r fig.cap="Database Backend", echo=FALSE}
